...
@pytest.mark.parametrize("compared, expected", [
    ({'kind': 'securemesh_site_v2', 'metadata': {'name': 'f5xc-aws-ce-test-61', 'labels': {'hw-serial-number': 'ec2a4ade-2eef-8f87-ff02-97a11c6aac36'}},
     ...
     ['kind', 'metadata/name', 'spec/vip_vrrp_mode', 'spec/site_to_site_ipsec_connectivity', 'spec/main_nodes/0/name', 'spec/main_nodes/0/slo_address', 'spec/main_nodes/1/name', 'spec/main_nodes/1/slo_address', 'spec/main_nodes/2/name', 'spec/main_nodes/2/slo_address', 'spec/proactive_monitoring', 'nodes/node0/hw_info/memory/speed', 'nodes/node0/interfaces', 'nodes/node1/interfaces', 'nodes/node2/interfaces', 'namespaces/pg-vsite-testing/proxys', 'namespaces/pg-vsite-testing/loadbalancer/http',
      'namespaces/pg-vsite-testing/loadbalancer/tcp', 'namespaces/pg-vsite-testing/origin_pools', 'bgp', 'None/worker_node_count']),
    "f5xc-aws-ce-test-60",
    data_old(api())
])
def test_get_keys(api, compared, expected, old_site, data_old):
    r = []
    assert api._get_keys(None, compared, r, old_site, data_old) == expected
