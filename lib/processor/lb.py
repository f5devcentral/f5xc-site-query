    ...
    def run(self) -> dict:
        ...
        def process():
            try:
                ...
                if "loadbalancer" not in self.data[c.SITES_KEY][site_name]['namespaces'][namespace].keys():
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"] = dict()

                if QUERY_STRING_LB_TCP in future_to_ds[future]:
                    if "tcp" not in self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"].keys():
                        self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["tcp"] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["tcp"][lb_name] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["tcp"][lb_name]['spec'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["tcp"][lb_name]['metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["tcp"][lb_name]['system_metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["tcp"][lb_name]['spec'] = r['spec']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["tcp"][lb_name]['metadata'] = r['metadata']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["tcp"][lb_name]['system_metadata'] = r['system_metadata']
                if QUERY_STRING_LB_UDP in future_to_ds[future]:
                    if "udp" not in self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"].keys():
                        self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["udp"] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["udp"][lb_name] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["udp"][lb_name]['spec'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["udp"][lb_name]['metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["udp"][lb_name]['system_metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["udp"][lb_name]['spec'] = r['spec']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["udp"][lb_name]['metadata'] = r['metadata']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["udp"][lb_name]['system_metadata'] = r['system_metadata']
                if QUERY_STRING_LB_HTTP in future_to_ds[future]:
                    if "http" not in self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"].keys():
                        self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["http"] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["http"][lb_name] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["http"][lb_name]['spec'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["http"][lb_name]['metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]["loadbalancer"]["http"][lb_name]['system_metadata'] = dict()
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["http"][lb_name]['spec'] = r['spec']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["http"][lb_name]['metadata'] = r['metadata']
                    self.data[c.SITES_KEY][site_name]['namespaces'][namespace]['loadbalancer']["http"][lb_name]['system_metadata'] = r['system_metadata']
